...
| <a name="input_job_state_time_limit_reason"></a> [job\_state\_time\_limit\_reason](#input\_job\_state\_time\_limit\_reason) | The reason for job state timeout | `string` | `null` | no |
| <a name="input_job_state_time_limit_timeout"></a> [job\_state\_time\_limit\_timeout](#input\_job\_state\_time\_limit\_timeout) | The timeout for job state in seconds | `number` | `null` | no |
